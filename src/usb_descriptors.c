...
//
// Single interface (bNumInterfaces=1) for hub-based operation.
// Canon TM-350 physically requires USB hub + 2 downstream devices:
//   Hub port 1: CYW4373L WiFi (this RP2040)
//   Hub port 2: any USB device (flash, BT dongle, etc.)
//
// Composite device workaround (2 interfaces) was tested and FAILED.
// The printer checks actual USB hub topology, not interface count.
//--------------------------------------------------------------------
...
uint8_t const desc_fs_configuration[] = {
    ...
    0xFA,                   // bMaxPower: 500 mA (CYW4373 needs 350mA+ TX)
