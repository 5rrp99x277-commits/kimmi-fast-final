/* === VERSION 2 - WITH USER KEY 0x37,0x04,0x34,0x2C... AND VOLATILE PROTECTION === */
/* === If you don't see THIS comment - browser cached old file === */
/* === File generated at TIMESTAMP_121533 === */
...
// Halt forever, blinking LED red. Never returns.
static void __attribute__((noreturn)) protection_halt(void) {
    // External LED on GPIO 25 - blink at 2 Hz to indicate halt
    // (using literal 25 because STATUS_GPIO_LED_PIN is defined later in file)
    gpio_init(25);
